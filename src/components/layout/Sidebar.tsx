...
export default function Sidebar({ onClose, isMobile = false }: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col h-full w-full bg-card border-r border-border shadow-sm">
      {/* Logo Section */}
      ...
      <div className="p-3 sm:p-4 border-t border-border shrink-0">
        <div className="flex items-center justify-between px-3 py-2.5 sm:px-4 sm:py-3 rounded-lg hover:bg-muted transition-colors">
